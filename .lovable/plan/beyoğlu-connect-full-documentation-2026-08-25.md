...
Below is the complete documentation of the app as it exists today. Approving this plan saves it into the project as `DOCUMENTATION.md` (no code behaviour changes).
...
Write the content above to `DOCUMENTATION.md` at the project root and link it from `README.md`. No application code changes.
